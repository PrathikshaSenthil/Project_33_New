...
function preload()
{
  ...
  food = loadImage('mask.png');
  rabbit = loadImage('Rabbit-01.png');

  blink = loadAnimation("girl1.png");
  eat = loadAnimation("girl23.png");
...
function setup() {
  ...
  blink.frameDelay = 20;
  eat.frameDelay = 20;
  bunny = createSprite(275,135,100,100);
  bunny.addImage(rabbit);
  bunny.scale = 0.15;
  higherground =new Ground(280,210,60,10);
  ...
  //btn 1
  button = createImg('cut_b.png');
  button.position(200,320);
  button.size(50,50);

  button2 = createImg('cut_b.png');
...
{
  background(51);
  image(bg_img,-80,-100,width+200,height+80);
  ...
  if(collide(fruit,bunny,80)==true)
  {
   ...
   bubble.visible = false;
    ...
    fruit = null;
    //bunny.change('eating');
    bunny.position.x=275;
    bunny.position.y=153;
    higherground =new Ground(280,220,60,10);
